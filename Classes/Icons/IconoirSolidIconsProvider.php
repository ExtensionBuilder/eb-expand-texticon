...
class IconoirSolidIconsProvider implements IconProviderInterface
{

    public function getIdentifier(): string
    {
        return 'EXT:eb_expand_texticon/Resources/Public/Images/Icons/iconoir/solid/';
    }

    public function getName(): string
    {
        return 'Iconoir Solid';
    }

    public function supports(string $identifier): bool
    {
        return 'EXT:eb_expand_texticon/Resources/Public/Images/Icons/iconoir/solid/' === $identifier;
    }
    ...
    public function getIconList(): IconList
    {
        ...
        $directory = 'EXT:eb_expand_texticon/Resources/Public/Images/Icons/iconoir/solid/';
