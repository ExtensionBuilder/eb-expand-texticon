...
class TablerOutlineIconsProvider implements IconProviderInterface
{

    public function getIdentifier(): string
    {
        return 'EXT:eb_expand_texticon/Resources/Public/Images/Icons/tabler/outline/';
    }
    ...
    {
        return 'EXT:eb_expand_texticon/Resources/Public/Images/Icons/tabler/outline/' === $identifier;
    }
    ...
    public function getIconList(): IconList
    {
        ...
        $directory = 'EXT:eb_expand_texticon/Resources/Public/Images/Icons/tabler/outline/';
