...
class IconoirRegularIconsProvider implements IconProviderInterface
{

    public function getIdentifier(): string
    {
        return 'EXT:eb_expand_texticon/Resources/Public/Images/Icons/iconoir/regular/';
    }

    public function getName(): string
    {
        return 'Iconoir Regular';
    }

    public function supports(string $identifier): bool
    {
        return 'EXT:eb_expand_texticon/Resources/Public/Images/Icons/iconoir/regular/' === $identifier;
    }
    ...
    public function getIconList(): IconList
    {
        ...
        $directory = 'EXT:eb_expand_texticon/Resources/Public/Images/Icons/iconoir/regular/';
